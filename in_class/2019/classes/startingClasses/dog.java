/**
 * Author: Nick File: dog.java Purpose: To define the Dog class.
 */
...
public class dog {
  ...
  /** want to be able to set: name, mass, isHungry, and breed. So use a new
  * constructor w/ args
  * useful constructor:
  */
  ...
  public int bite() { // if bite is used, do this
    if (goodness > 5)
      ...
      return (int) (10 * mass); // number value is the damage done. in this case, a big dog will do more damage.
                                // if its goodness is over 5, then it doesnt bite
  }
