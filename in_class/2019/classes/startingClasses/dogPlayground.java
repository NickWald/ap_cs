...
//CREATING A DATA TYPE CALLED BOOMER
//Holds data defined in class, but can use methods from the class
    boomer.bark(); //this says: look inside boomer, find the method inside boomer, and execute/
    boomer.bite();
    boomer.feed();
  }
}
