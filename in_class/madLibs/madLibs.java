...
* Nick Wald
* 9/17/19
* Purpose: Making a primitive MadLibs
*/
...
//output:
    System.out.println("One day, " + name + ", who's username has been set to " + userName + ", was " + verb + " down " + streetName + " when he ran into " +  friendName + ". He shot him in the face.");
		System.out.println("");
		System.out.println("The reason for this sudden agression was unknown, but it was clear that " + userName + " was now on the run. He made his way down " + streetName2 + " as quickly as he could, and instantly ran into officer " + officerName + ". Now in handcuffs with fingers stained blood-red, " + userName + " knew it was all over.");
		System.out.println("");
		System.out.println("Some time later, " + userName + "'s time for a trial had come, and he was found guilty -  sentenced to " + prisonSentence);
		System.out.println("");
