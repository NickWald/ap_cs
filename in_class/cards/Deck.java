...
public class Deck
{
  ...
  /**
   * Shuffles the deck, using Collections.shuffle. Will shuffle a random number
   * of times, from 1-52 to increase final randomness.
   */
  ...
  /**
   * @param c
   *          a card to remove from the deck and drawn piles, to be placed in
   *          the discard pile.
   */
